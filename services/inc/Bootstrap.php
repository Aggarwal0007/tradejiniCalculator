...
require_once PROJECT_ROOT_PATH . "/inc/CurlApi.php";
...
require_once PROJECT_ROOT_PATH . "/model/SpanCalcModel.php";
require_once PROJECT_ROOT_PATH . "/model/SymbolStoreModel.php";
